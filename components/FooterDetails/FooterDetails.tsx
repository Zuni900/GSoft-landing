    ...
    <Grid container className={cx(classes.container)}>
      <Grid container item md={10} className={cx(classes.box)}>
        <Grid item md={2.5} sm={5} xs={12} className={cx(classes.block)}>
          <Text variant="h4" name="COMPANY" className={cx(classes.heading)} />
        ...
        <Grid item md={2.5} sm={5} xs={12} className={cx(classes.block)}>
          <Text variant="h4" name="SERVICES" className={cx(classes.heading)} />
        ...
        <Grid item md={4} sm={5} xs={12} className={cx(classes.block)}>
          <Text variant="h4" name="TECHNOLOGIES" className={cx(classes.heading)} />
        ...
        <Grid item md={2.5} sm={5} xs={12} className={cx(classes.block)}>
          <Text variant="h4" name="OFFICES" className={cx(classes.heading)} />
